...
APP_LOGO = Setting('APP_LOGO', '/i/common/media/img/logo.png', BASIC_SET, dict(
label = _("Application logo"),
help_text = _("Your site main logo."),
widget=ImageFormWidget))

APP_FAVICON = Setting('APP_FAVICON', '/i/common/media/img/favicon.ico', BASIC_SET, dict(
label = _("Favicon"),
help_text = _("Your site favicon."),
widget=ImageFormWidget))

APP_TITLE = Setting('APP_TITLE', u'Quests', BASIC_SET, dict(
...
APP_DESCRIPTION = Setting('APP_DESCRIPTION', u'Post quests or tackle open quests!', BASIC_SET, dict(
label = _("Application description"),
help_text = _("The description of your application"),
widget=Textarea))

APP_COPYRIGHT = Setting('APP_COPYRIGHT', u'Copyright Fusion OI, 2014. Some rights reserved under creative commons license.', BASIC_SET, dict(
